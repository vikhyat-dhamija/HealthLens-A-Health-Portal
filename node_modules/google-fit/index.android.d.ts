...
declare module "google-fit" {
    export interface GoogleFit {
         ...
         */
        getDailyStepCountSamples: (options: any, callback?: ((isError: boolean, result: any) => void)) => Promise<any>;

        getDailySleepDataSamples: (options: any, callback?: ((isError: boolean, result: any) => void)) => Promise<any>;
        ...
        */
        ...
        saveSleepData: (options: any, callback?: ((isError: boolean, result: any) => void)) => Promise<any>;
