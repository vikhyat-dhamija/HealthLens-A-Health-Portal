...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 14 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">
Check performed at Thu Sep 19 17:45:05 ICT 2019      </nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#SimpleDateFormat"><i class="material-icons warning-icon">warning</i>Implied locale in date format (6)</a>
      ...
      <a class="mdl-navigation__link" href="#StaticFieldLeak"><i class="material-icons warning-icon">warning</i>Static Field Leaks (5)</a>
    </nav>
  </div>
...
<tr><td></td><td class="categoryColumn"><a href="#MissingIssues">Disabled Checks (33)</a>
</td></tr></table>
<br/>              </div>
...
<span class="location"><a href="../../src/main/java/com/reactnative/googlefit/RecordingApi.java">../../src/main/java/com/reactnative/googlefit/RecordingApi.java</a>:64</span>: <span class="message">Implicitly using the default locale is a common source of bugs: Use <code>toUpperCase(Locale)</code> instead. For strings meant to be internal use <code>Locale.ROOT</code>, otherwise <code>Locale.getDefault()</code>.</span><br /><pre class="errorlines">
<span class="lineno">  61 </span>    }
<span class="lineno">  62 </span>
<span class="lineno">  63 </span>    <span class="keyword">public</span> <span class="keyword">static</span> String getEventName(String dataTypeName) {
<span class="caretline"><span class="lineno">  64 </span>        <span class="keyword">return</span> dataTypeName.<span class="warning">toUpperCase</span>() + <span class="string">"_RECORDING"</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  65 </span>    }
<span class="lineno">  66 </span>
<span class="lineno">  67 </span>    <span class="keyword">public</span> RecordingApi (ReactContext reactContext, GoogleFitManager googleFitManager) {
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/reactnative/googlefit/BodyHistory.java">../../src/main/java/com/reactnative/googlefit/BodyHistory.java</a>:241</span>: <span class="message">To get local formatting use <code>getDateInstance()</code>, <code>getDateTimeInstance()</code>, or <code>getTimeInstance()</code>, or use <code>new SimpleDateFormat(String template, Locale locale)</code> with for example <code>Locale.US</code> for ASCII dates.</span><br /><pre class="errorlines">
<span class="lineno"> 238 </span>
<span class="lineno"> 239 </span>    <span class="keyword">private</span> <span class="keyword">void</span> processDataSet(DataSet dataSet, WritableArray map) {
<span class="lineno"> 240 </span>        <span class="comment">//Log.i(TAG, "Data returned for Data type: " + dataSet.getDataType().getName());</span>
<span class="caretline"><span class="lineno"> 241 </span>        Format formatter = <span class="warning"><span class="keyword">new</span> SimpleDateFormat(<span class="string">"EEE"</span>)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 242 </span>
<span class="lineno"> 243 </span>        WritableMap stepMap = Arguments.createMap();
</pre>

<span class="location"><a href="../../src/main/java/com/reactnative/googlefit/CalorieHistory.java">../../src/main/java/com/reactnative/googlefit/CalorieHistory.java</a>:139</span>: <span class="message">To get local formatting use <code>getDateInstance()</code>, <code>getDateTimeInstance()</code>, or <code>getTimeInstance()</code>, or use <code>new SimpleDateFormat(String template, Locale locale)</code> with for example <code>Locale.US</code> for ASCII dates.</span><br /><pre class="errorlines">
<span class="lineno"> 136 </span>        Log.i(TAG, <span class="string">"Data returned for Data type: "</span> + dataSet.getDataType().getName());
<span class="lineno"> 137 </span>        DateFormat dateFormat = DateFormat.getDateInstance();
<span class="lineno"> 138 </span>        DateFormat timeFormat = DateFormat.getTimeInstance();
<span class="caretline"><span class="lineno"> 139 </span>        Format formatter = <span class="warning"><span class="keyword">new</span> SimpleDateFormat(<span class="string">"EEE"</span>)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 140 </span>        WritableMap stepMap = Arguments.createMap();
<span class="lineno"> 141 </span>
</pre>

<span class="location"><a href="../../src/main/java/com/reactnative/googlefit/DistanceHistory.java">../../src/main/java/com/reactnative/googlefit/DistanceHistory.java</a>:96</span>: <span class="message">To get local formatting use <code>getDateInstance()</code>, <code>getDateTimeInstance()</code>, or <code>getTimeInstance()</code>, or use <code>new SimpleDateFormat(String template, Locale locale)</code> with for example <code>Locale.US</code> for ASCII dates.</span><br /><pre class="errorlines">
<span class="lineno">  93 </span>        Log.i(TAG, <span class="string">"Data returned for Data type: "</span> + dataSet.getDataType().getName());
<span class="lineno">  94 </span>        DateFormat dateFormat = DateFormat.getDateInstance();
<span class="lineno">  95 </span>        DateFormat timeFormat = DateFormat.getTimeInstance();
<span class="caretline"><span class="lineno">  96 </span>        Format formatter = <span class="warning"><span class="keyword">new</span> SimpleDateFormat(<span class="string">"EEE"</span>)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  97 </span>
<span class="lineno">  98 </span>        WritableMap stepMap = Arguments.createMap();
</pre>

<span class="location"><a href="../../src/main/java/com/reactnative/googlefit/HeartrateHistory.java">../../src/main/java/com/reactnative/googlefit/HeartrateHistory.java</a>:225</span>: <span class="message">To get local formatting use <code>getDateInstance()</code>, <code>getDateTimeInstance()</code>, or <code>getTimeInstance()</code>, or use <code>new SimpleDateFormat(String template, Locale locale)</code> with for example <code>Locale.US</code> for ASCII dates.</span><br /><pre class="errorlines">
<span class="lineno"> 222 </span>    <span class="keyword">private</span> <span class="keyword">void</span> processDataSet(DataSet dataSet, WritableArray map) {
<span class="lineno"> 223 </span>
<span class="lineno"> 224 </span>        <span class="comment">//Log.i(TAG, "Data returned for Data type: " + dataSet.getDataType().getName());</span>
<span class="caretline"><span class="lineno"> 225 </span>        Format formatter = <span class="warning"><span class="keyword">new</span> SimpleDateFormat(<span class="string">"EEE"</span>)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 226 </span><span class="comment">//        WritableMap stepMap = Arguments.createMap();</span>
<span class="lineno"> 227 </span>
<span class="lineno"> 228 </span>        <span class="keyword">for</span> (DataPoint dp : dataSet.getDataPoints()) {
</pre>

<span class="location"><a href="../../src/main/java/com/reactnative/googlefit/StepHistory.java">../../src/main/java/com/reactnative/googlefit/StepHistory.java</a>:64</span>: <span class="message">To get local formatting use <code>getDateInstance()</code>, <code>getDateTimeInstance()</code>, or <code>getTimeInstance()</code>, or use <code>new SimpleDateFormat(String template, Locale locale)</code> with for example <code>Locale.US</code> for ASCII dates.</span><br /><pre class="errorlines">
<span class="lineno">  61 </span>
<span class="lineno">  62 </span>  <span class="keyword">public</span> <span class="keyword">void</span> aggregateDataByDate(<span class="keyword">long</span> startTime, <span class="keyword">long</span> endTime, <span class="keyword">final</span> Callback successCallback) {
<span class="lineno">  63 </span>
<span class="caretline"><span class="lineno">  64 </span>      DateFormat dateFormat = <span class="warning"><span class="keyword">new</span> SimpleDateFormat(<span class="string">"yyyy-MM-dd'T'HH:mm:ss.SSSZ"</span>)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  65 </span>      dateFormat.setTimeZone(TimeZone.getDefault());
<span class="lineno">  66 </span>
<span class="lineno">  67 </span>      Log.i(TAG, <span class="string">"Range Start: "</span> + dateFormat.format(startTime));
</pre>

<span class="location"><a href="../../src/main/java/com/reactnative/googlefit/StepHistory.java">../../src/main/java/com/reactnative/googlefit/StepHistory.java</a>:271</span>: <span class="message">To get local formatting use <code>getDateInstance()</code>, <code>getDateTimeInstance()</code>, or <code>getTimeInstance()</code>, or use <code>new SimpleDateFormat(String template, Locale locale)</code> with for example <code>Locale.US</code> for ASCII dates.</span><br /><pre class="errorlines">
<span class="lineno"> 268 </span>    <span class="keyword">private</span> <span class="keyword">void</span> processDataSet(DataSet dataSet, WritableArray map) {
<span class="lineno"> 269 </span>        <span class="comment">//Log.i(TAG, "Data returned for Data type: " + dataSet.getDataType().getName());</span>
<span class="lineno"> 270 </span>
<span class="caretline"><span class="lineno"> 271 </span>        DateFormat dateFormat = <span class="warning"><span class="keyword">new</span> SimpleDateFormat(<span class="string">"yyyy-MM-dd'T'HH:mm:ss.SSSZ"</span>)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 272 </span>        dateFormat.setTimeZone(TimeZone.getDefault());
<span class="lineno"> 273 </span>
<span class="lineno"> 274 </span>        WritableMap stepMap = Arguments.createMap();
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:10</span>: <span class="message">A newer version of com.android.tools.build:gradle than 3.3.1 is available: 3.5.0</span><br /><pre class="errorlines">
<span class="lineno">  7 </span>    }
<span class="lineno">  8 </span>
<span class="lineno">  9 </span>    dependencies {
<span class="caretline"><span class="lineno"> 10 </span>        <span class="warning">classpath <span class="string">'com.android.tools.build:gradle:3.3.1'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:37</span>: <span class="message">Avoid using + in version numbers; can lead to unpredictable and unrepeatable builds (com.facebook.react:react-native:+)</span><br /><pre class="errorlines">
<span class="lineno"> 34 </span>
<span class="lineno"> 35 </span>dependencies {
<span class="lineno"> 36 </span>    implementation fileTree(include: [<span class="string">'*.jar'</span>], dir: <span class="string">'libs'</span>)
<span class="caretline"><span class="lineno"> 37 </span>    <span class="warning">implementation <span class="string">'com.facebook.react:react-native:+'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 38 </span>    implementation <span class="string">"com.google.android.gms:play-services-auth:${safeExtGet('authVersion', '+')}"</span>
<span class="lineno"> 39 </span>    implementation <span class="string">"com.google.android.gms:play-services-fitness:${safeExtGet('fitnessVersion', '+')}"</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/reactnative/googlefit/BodyHistory.java">../../src/main/java/com/reactnative/googlefit/BodyHistory.java</a>:141</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (com.reactnative.googlefit.BodyHistory.DeleteDataTask)</span><br /><pre class="errorlines">
<span class="lineno"> 138 </span>    }
<span class="lineno"> 139 </span>
<span class="lineno"> 140 </span>    <span class="comment">//Async fit data delete</span>
<span class="caretline"><span class="lineno"> 141 </span>    <span class="keyword">private</span> <span class="keyword">class</span> <span class="warning">DeleteDataTask</span> <span class="keyword">extends</span> AsyncTask&lt;Void, Void, Void> {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 142 </span>
<span class="lineno"> 143 </span>        <span class="keyword">long</span> startTime;
<span class="lineno"> 144 </span>        <span class="keyword">long</span> endTime;
</pre>

<span class="location"><a href="../../src/main/java/com/reactnative/googlefit/BodyHistory.java">../../src/main/java/com/reactnative/googlefit/BodyHistory.java</a>:176</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (com.reactnative.googlefit.BodyHistory.InsertAndVerifyDataTask)</span><br /><pre class="errorlines">
<span class="lineno"> 173 </span>
<span class="lineno"> 174 </span>
<span class="lineno"> 175 </span>    <span class="comment">//Async fit data insert</span>
<span class="caretline"><span class="lineno"> 176 </span>    <span class="keyword">private</span> <span class="keyword">class</span> <span class="warning">InsertAndVerifyDataTask</span> <span class="keyword">extends</span> AsyncTask&lt;Void, Void, Void> {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 177 </span>
<span class="lineno"> 178 </span>        <span class="keyword">private</span> DataSet Dataset;
</pre>

<span class="location"><a href="../../src/main/java/com/reactnative/googlefit/CalorieHistory.java">../../src/main/java/com/reactnative/googlefit/CalorieHistory.java</a>:190</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (com.reactnative.googlefit.CalorieHistory.InsertAndVerifyDataTask)</span><br /><pre class="errorlines">
<span class="lineno"> 187 </span>    }
<span class="lineno"> 188 </span>
<span class="lineno"> 189 </span>    <span class="comment">//Async fit data insert</span>
<span class="caretline"><span class="lineno"> 190 </span>    <span class="keyword">private</span> <span class="keyword">class</span> <span class="warning">InsertAndVerifyDataTask</span> <span class="keyword">extends</span> AsyncTask&lt;Void, Void, Void> {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 191 </span>
<span class="lineno"> 192 </span>        <span class="keyword">private</span> DataSet FoodDataset;
</pre>

<span class="location"><a href="../../src/main/java/com/reactnative/googlefit/HeartrateHistory.java">../../src/main/java/com/reactnative/googlefit/HeartrateHistory.java</a>:124</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (com.reactnative.googlefit.HeartrateHistory.DeleteDataTask)</span><br /><pre class="errorlines">
<span class="lineno"> 121 </span>    }
<span class="lineno"> 122 </span>
<span class="lineno"> 123 </span>    <span class="comment">//Async fit data delete</span>
<span class="caretline"><span class="lineno"> 124 </span>    <span class="keyword">private</span> <span class="keyword">class</span> <span class="warning">DeleteDataTask</span> <span class="keyword">extends</span> AsyncTask&lt;Void, Void, Void> {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 125 </span>
<span class="lineno"> 126 </span>        <span class="keyword">long</span> startTime;
<span class="lineno"> 127 </span>        <span class="keyword">long</span> endTime;
</pre>

<span class="location"><a href="../../src/main/java/com/reactnative/googlefit/HeartrateHistory.java">../../src/main/java/com/reactnative/googlefit/HeartrateHistory.java</a>:159</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (com.reactnative.googlefit.HeartrateHistory.InsertAndVerifyDataTask)</span><br /><pre class="errorlines">
<span class="lineno"> 156 </span>
<span class="lineno"> 157 </span>
<span class="lineno"> 158 </span>    <span class="comment">//Async fit data insert</span>
<span class="caretline"><span class="lineno"> 159 </span>    <span class="keyword">private</span> <span class="keyword">class</span> <span class="warning">InsertAndVerifyDataTask</span> <span class="keyword">extends</span> AsyncTask&lt;Void, Void, Void> {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 160 </span>
<span class="lineno"> 161 </span>        <span class="keyword">private</span> DataSet Dataset;
</pre>
